...
export const Home: React.FC = () => {
  ...
  return (
    <div className="bg-light min-h-screen">
      <section className="relative min-h-[95vh] lg:h-[85vh] bg-dark flex items-center overflow-hidden py-12 lg:py-0">
      ...
      {/* Margined Page Layout Starts Here */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-24">
        ...
        {/* 3. BEST SELLERS (Carousel with Side Banner) */}
        <section className="space-y-8">
          <div className="text-center space-y-2">
        ...
        {/* 4. COLLECTIONS SHOWCASE (Full-width card styled inside grid) */}
